---
title: GDPR
description: Understand how Omni Sign handles GDPR compliance for data processing and storage.
---
...
When using Omni Sign for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using Omni Sign) determine the purposes and means of processing |
| **Data Processor**  | Omni Sign processes personal data on your behalf according to your instructions       |
...
As the data processor, Omni Sign:
...
Omni Sign processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use Omni Sign:

<Tabs items={['Omni Sign Cloud', 'Self-Hosted']}>
<Tab value="Omni Sign Cloud">
...
Contact Omni Sign for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host Omni Sign:

- You control all data storage locations
- No data is transmitted to Omni Sign's infrastructure
...
- Export user and document data from your Omni Sign account
- Delete user accounts and associated documents
- Contact Omni Sign support for assistance with cloud-hosted data

## Data Deletion

Omni Sign supports data deletion to help fulfill erasure requests:
...
Self-hosting Omni Sign can simplify GDPR compliance:
...
- The DPA covers Omni Sign's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with Omni Sign is required since no personal data is processed by Omni Sign.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use Omni Sign, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy Omni Sign on your own infrastructure
