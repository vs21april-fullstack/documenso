...
<Callout type="info">
  Omni Sign seals all signed documents cryptographically, regardless of signature level, to prevent
...
## What Omni Sign Provides

Omni Sign supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
