...
description: Integrate Omni Sign into your applications using the REST API, webhooks, and embedding options.
---
...
<Cards>
  ...
  <Card
    title="Self-Hosting"
    description="Deploy your own Omni Sign instance."
