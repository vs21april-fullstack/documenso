---
title: Manual Setup
description: Manually set up Omni Sign on your machine for local development.
---
...
Follow these steps to set up Omni Sign on your local machine:
...
Fork the [Omni Sign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
Access the Omni Sign application by visiting `http://localhost:3000` in your web browser.
