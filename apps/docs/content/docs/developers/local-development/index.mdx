...
description: Learn how to set up Omni Sign for local development.
---

## Overview

There are multiple ways of setting up Omni Sign for local development. At the moment of writing this documentation, there are 3 ways of running Omni Sign locally:
...
- [Contributing](/docs/developers/contributing) - Learn how to contribute to Omni Sign
