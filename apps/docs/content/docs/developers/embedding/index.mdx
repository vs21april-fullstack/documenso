...
Omni Sign offers two types of embedding:
...
<Steps>
<Step>
Navigate to your team's templates in Omni Sign
...
| `host`                | `string`   | Omni Sign instance URL. Defaults to `https://app.documenso.com`. |
