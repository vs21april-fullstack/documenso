...
In addition to embedding signing, Omni Sign supports embedded editor. It allows your users to create and edit documents, templates, and envelopes without leaving your application.
...
This endpoint requires your Omni Sign API key. The token has a default expiration of 1 hour.
