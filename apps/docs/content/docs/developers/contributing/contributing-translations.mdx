...
description: Learn how to contribute translations to Omni Sign and become part of our community.
---
...
msgid "Want to send slick signing links like this one? <0>Check out Omni Sign.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie Omni Sign.</0>"
```
...
Thank you for helping make Omni Sign more accessible to users around the world!
