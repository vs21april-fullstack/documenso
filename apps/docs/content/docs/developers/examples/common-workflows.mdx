...
Register your endpoint in the Omni Sign dashboard:
...
<Steps>
  ...
  <Step>
    Enter your webhook URL (e.g. <code>https://your-app.com/webhooks/documenso</code>)
  </Step>
  <Step>
...
class Omni SignApiError extends Error {
  code?: string;
  statusCode: number;
  details?: Record<string, unknown>;
...
try {
  ...
  if (error instanceof Omni SignApiError) {
