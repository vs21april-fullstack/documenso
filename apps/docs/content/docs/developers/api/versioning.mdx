...
description: Versioning information for the Omni Sign public API.
---
...
Omni Sign uses API versioning to manage changes to the public API. This allows us to introduce new features, fix bugs, and make other changes without breaking existing integrations.
