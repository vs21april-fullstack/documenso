---
title: Verifying Emails from Omni Sign
description: How to confirm that an email is genuinely from Omni Sign, and what to do if you receive a suspicious message.
---
...
All email sent by Omni Sign originates from one of the following domains. If you receive an email claiming to be from Omni Sign and the sender address does not end in one of these domains, treat it as suspicious.
...
<Callout type="warn">
  A misspelling such as `documenso-email.com`, `documensoemaiI.com` (capital i instead of l), or any other variation is not a Omni Sign domain.
</Callout>

## Types of Email Omni Sign Sends

Omni Sign sends email only for the following purposes:
...
3. **Watch for urgency or threats** — legitimate Omni Sign emails do not threaten account suspension to pressure you into clicking a link immediately
...
If you receive an email that appears to impersonate Omni Sign:
...
- [Security Policy](/docs/policies/security) — Omni Sign's security practices and vulnerability disclosure process
