---
title: Security
description: Security practices for Omni Sign Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from Omni Sign is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    Omni Sign encrypts sensitive data at the application level:
...
Omni Sign operates a responsible disclosure process for security vulnerabilities.
...
When self-hosting Omni Sign, you are responsible for the security of your deployment. The following recommendations apply:
