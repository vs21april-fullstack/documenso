---
title: Licenses
description: Omni Sign uses a dual licensing model with an open-source AGPL-3.0 license (Community Edition) and a commercial license (Enterprise Edition).
---
...
- Use Omni Sign for any purpose, including commercial use
- Access, study, and modify the source code
- Distribute copies of the original or modified software
- Self-host Omni Sign on your own infrastructure

### What AGPL-3.0 Requires

The AGPL-3.0 has specific requirements that apply when you modify or distribute Omni Sign:

**Source Code Disclosure**: If you modify Omni Sign and make it available over a network, you must provide access to the complete source code of your modified version under AGPL-3.0.
...
<Callout type="info">
  ...
  network access as distribution. If users interact with your modified Omni Sign instance over a
...
- Use Omni Sign internally without modifications
...
The Enterprise Edition provides a commercial license that removes the AGPL-3.0 requirements. This allows organisations to use, modify, and integrate Omni Sign without source code disclosure obligations.
...
**Proprietary Integration**: Integrate Omni Sign into proprietary products and services without licensing conflicts.
...
- Build commercial products that incorporate Omni Sign
...
<Callout type="warn">
  If you modify Omni Sign and provide network access to users (internal or external) without
...
<Accordions type="multiple">
  <Accordion title="Do you modify Omni Sign?">
    **No modifications**: Both licenses work. Community Edition is free and sufficient if you run Omni Sign as-is.
  ...
  <Accordion title="Are you embedding Omni Sign in a commercial product?">
  ...
  <Accordion title="Internal use only?">
    Using Omni Sign internally without providing network access to external users does not trigger AGPL-3.0 distribution requirements. However, if your organisation has policies against AGPL software or you make modifications you want to keep private, consider the Enterprise Edition.
  </Accordion>
</Accordions>
...
<Accordions type="multiple">
  ...
  <Accordion title="Does using the Omni Sign API require a commercial license?">
    No. Calling the Omni Sign API from your application does not create a derivative work. Your
    application remains under your chosen license. However, if you modify Omni Sign itself and
    provide network access, AGPL-3.0 requirements apply.
  </Accordion>
  <Accordion title='What counts as a "modification" under AGPL-3.0?'>
    Modifying the source code, forking the repository and making changes, or linking Omni Sign
    libraries into your application in a way that creates a combined work. Configuration changes and
    using Omni Sign through its API are not modifications.
  </Accordion>
  <Accordion title="Can I white-label Omni Sign?">
  ...
  <Accordion title="Can I contribute to Omni Sign under the Enterprise license?">
    Contributions to the main Omni Sign repository are licensed under AGPL-3.0. The Enterprise
