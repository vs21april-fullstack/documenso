...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate Omni Sign into proprietary products.
---
...
- **Build proprietary products**: Integrate Omni Sign into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to Omni Sign source code that you don't want to disclose

<Callout type="info">
  If you run Omni Sign without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using Omni Sign API only        | Community Edition  |
| SaaS product with modified Omni Sign code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed Omni Sign in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute Omni Sign as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    ...
    4. Restart your Omni Sign instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and Omni Sign. Key terms include:

    - **Scope**: License to use, modify, and distribute Omni Sign as specified in your agreement
    - **Exclusions**: The license does not grant rights to Omni Sign trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - Omni Sign Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or Omni Sign Cloud      |
...
<Steps>
  ...
  <Step>
    ...
    Options for evaluating Omni Sign before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access Omni Sign Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include Omni Sign Cloud?">
