...
- **Create one automatically**: Omni Sign creates a new "Direct Link Recipient" for you
...
If the recipient has a Omni Sign account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public Omni Sign profile:
...
![Omni Sign profile with direct links](/direct-links/documenso-profile.webp)
