---
title: Overview
description: Organisations are the top-level entity in Omni Sign, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in Omni Sign's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in Omni Sign dashboard](/organisations/organisations-create.webp)
