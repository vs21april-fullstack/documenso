...
description: Sign up for Omni Sign and configure your profile.
---
...
<img 
  ...
  alt="Omni Sign registration form with name, email, and password fields"
...
<Steps>
  <Step>
    ...
    ![Omni Sign account security page showing security options](/get-started-images/documenso-account-security-page.webp)
