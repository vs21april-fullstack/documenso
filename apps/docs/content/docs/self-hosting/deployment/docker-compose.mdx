...
description: Deploy Omni Sign with Docker Compose, including PostgreSQL. This production-ready setup is suitable for most self-hosted deployments.
---
...
The Omni Sign container waits for the database health check to pass before starting.
...
# Public URL where Omni Sign is accessible
...
For production, place Omni Sign behind a reverse proxy for SSL termination:
