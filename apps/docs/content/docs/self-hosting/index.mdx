---
title: Self-Hosting
description: Deploy and manage your own Omni Sign instance for complete control over your data, compliance, and customization.
---
...
<Callout type="error">
  **You must generate a signing certificate.** Omni Sign does not ship with one. Without a
...
<Callout type="warn">
  **You are responsible for your own network security.** Omni Sign applies best-effort, non-exhaustive
...
Get Omni Sign running locally in under 5 minutes:
...
Self-hosted Omni Sign includes full core functionality under the AGPL-3.0 license. If you need enterprise features such as SSO, embed editor white label, or 21 CFR Part 11 compliance, you can activate them with a license key.
...
<Cards>
  <Card
    title="User Guide"
    description="Learn how to use Omni Sign for document signing."
    href="/docs/users"
  />
  <Card
    title="Developer Guide"
    description="Integrate Omni Sign into your applications using the API."
