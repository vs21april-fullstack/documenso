---
title: Backups
description: Backup strategies for Omni Sign data.
---
...
Omni Sign stores data in three locations:
...
Create a script to back up all Omni Sign components:
...
echo "Starting Omni Sign backup: $TIMESTAMP"
...
```ini
[Unit]
Description=Daily Omni Sign Backup
