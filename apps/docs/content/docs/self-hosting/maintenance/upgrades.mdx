---
title: Upgrades
description: Upgrade your self-hosted Omni Sign installation to get the latest features, security patches, and bug fixes.
---
...
Omni Sign follows [Semantic Versioning](https://semver.org/):
...
Check your running Omni Sign version:
...
Omni Sign runs database migrations automatically when the container starts. No manual intervention is required.
