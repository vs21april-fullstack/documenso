...
description: Diagnose and resolve common issues with your self-hosted Omni Sign instance, organized by component.
---
...
Omni Sign exposes a health endpoint to verify the application is running:
...
<Steps>
  ...
  <Step>
    Change Omni Sign's port mapping: `-p 3001:3000`
  </Step>
</Steps>
...
```
  ...
  <Step>
    Update the certificate file and restart Omni Sign
  </Step>
</Steps>
...
- **[Discord](https://documen.so/discord)**: Join the Omni Sign community Discord
