import { e as A, w as T } from './chunk-KS7C4IRE-FYOnnPbz.js';
import { j as i } from './jsx-runtime-DrYFQjIW.js';
import { u as O } from './organisation-Ylr4XBmr.js';
import { u as C } from './session-DJFUfUIe.js';
import './document-CYL_BYk5.js';
import { D as I } from './document-preferences-form-DrLQXubl.js';
import { t as g } from './index-BbY_VZqi.js';
import { u as N } from './index-CkOHfBoV.js';
import { L as q } from './loader-aSxoB_gm.js';
import { a as Y } from './meta-1txnm5en.js';
import { i as H } from './organisations-CAYnRnac.js';
import { S as M } from './settings-header-C7I7HmzF.js';
...
const Pi = T(() => {
  const { isAiFeaturesConfigured: f } = A(),
    { organisations: S } = C(),
    n = O(),
    { _: t } = N(),
    { toast: m } = R(),
    x = H(S),
    { data: s, isLoading: D } = g.organisation.get.useQuery({ organisationReference: n.url }),
    { mutateAsync: b } = g.organisation.settings.update.useMutation(),
    y = async (j) => {
      try {
        const {
          ...
          documentLanguage: p,
          documentTimezone: P,
          documentDateFormat: a,
          includeSenderDetails: u,
          includeSigningCertificate: d,
          includeAuditLog: c,
          signatureTypes: r,
          defaultRecipients: w,
          delegateDocumentOwnership: E,
          aiFeaturesEnabled: l,
          envelopeExpirationPeriod: F,
          reminderSettings: v,
        } = j;
        if (o === null || p === null || a === null || u === null || d === null || c === null || l === null) {
        ...
        await b({
          ...
          data: {
            ...
            delegateDocumentOwnership: E,
            aiFeaturesEnabled: l,
            envelopeExpirationPeriod: F ?? void 0,
            reminderSettings: v ?? void 0,
          },
        }),
          m({ title: t({ id: 'FjIbFC' }), description: t({ id: 'ARqDVF' }) });
      } catch (o) {
        throw (m({ title: t({ id: 'ywDBfs' }), description: t({ id: 'sdujY+' }), variant: 'destructive' }), o);
      }
    };
  if (D || !s) {
    return i.jsx('div', {
      className: 'flex items-center justify-center rounded-lg py-32',
      children: i.jsx(q, { className: 'h-6 w-6 animate-spin text-muted-foreground' }),
    });
  }
  const L = t({ id: 'H90iLe' }),
    h = t(x ? { id: 'PjpXNQ' } : { id: 'bY0Udq' });
  return i.jsxs('div', {
    className: 'max-w-2xl',
    children: [
      i.jsx(M, { title: L, subtitle: h }),
      i.jsx('section', {
        children: i.jsx(I, {
          canInherit: !1,
          isAiFeaturesConfigured: f,
          settings: s.organisationGlobalSettings,
          onFormSubmit: y,
        }),
      }),
    ],
...
export { ji as meta, Pi as default };
