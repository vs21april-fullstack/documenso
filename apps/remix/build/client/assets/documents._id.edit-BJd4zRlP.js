...
import { r as c, w as d, L as f, b as l } from './chunk-KS7C4IRE-FYOnnPbz.js';
import { d as E, E as u, c as x } from './envelope-editor-renderer-provider-wrapper-BvKF77lt.js';
import { G as N } from './generic-error-layout-Ck6Ws6Ds.js';
import { t as h } from './index-BbY_VZqi.js';
import { i as T } from './index-browser-CnbpKWEs.js';
import { T as p } from './index-CkOHfBoV.js';
import { j as r } from './jsx-runtime-DrYFQjIW.js';
import { D as v } from './session-DJFUfUIe.js';
import { a as e } from './spinner-CEVyI0yx.js';
import { a as P } from './team-BvmzkpNi.js';
import { b as g, a as j } from './teams-WAT4Ivvc.js';
...
const Ft = d(({ params: s }) => {
  const i = l(),
    t = P(),
    {
      ...
      isLoading: a,
      isError: n,
    } = h.envelope.editor.get.useQuery({ envelopeId: s.id }, { retry: !1, gcTime: 0, ...v });
  return (
    c.useEffect(() => {
      if (!o) {
        return;
      }
      const m = o.type === T.EnvelopeType.DOCUMENT ? j(t.url) : g(t.url);
      o.teamId !== t.id
        ? i(m, { replace: !0 })
        : o.internalVersion !== 2 && i(`${m}/${o.id}/legacy_editor`, { replace: !0 });
    }, [o, t, i]),
    o && (o.teamId !== t.id || o.internalVersion !== 2)
      ? r.jsxs('div', {
          className: 'flex h-screen w-screen flex-col items-center justify-center gap-2 text-foreground',
          children: [r.jsx(e, {}), r.jsx(p, { id: 'x2yakr' })],
        })
      : a
        ? r.jsxs('div', {
            className: 'flex h-screen w-screen flex-col items-center justify-center gap-2 text-foreground',
            children: [r.jsx(e, {}), r.jsx(p, { id: 'yQE2r9' })],
          })
        : n || !o
          ? r.jsx(N, {
              errorCode: 404,
              errorCodeMap: {
                404: { heading: { id: 'KPx1UV' }, subHeading: { id: 'O2YINJ' }, message: { id: 'CMlhit' } },
              },
              primaryButton: r.jsx(y, {
                asChild: !0,
                children: r.jsx(f, { to: `/t/${t.url}/documents`, children: r.jsx(p, { id: 'iWpEwy' }) }),
              }),
            })
          : r.jsx(u, { initialEnvelope: o, children: r.jsx(x, { children: r.jsx(E, {}) }) })
  );
});
