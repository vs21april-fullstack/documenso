import { w as r } from './chunk-KS7C4IRE-FYOnnPbz.js';
import { I as s } from './inbox-6zwV6e62.js';
import { I as i } from './inbox-table-CIWlbSEA.js';
import { T as o } from './index-CkOHfBoV.js';
import { j as t } from './jsx-runtime-DrYFQjIW.js';
import { a as p } from './meta-1txnm5en.js';
import { O as m } from './organisation-invitations-BWGy8w6z.js';
      ...
      t.jsxs('div', {
        ...
        children: [
          t.jsxs('h1', {
            ...
            children: [t.jsx(s, { className: 'h-8 w-8 text-muted-foreground' }), t.jsx(o, { id: 'RAZekC' })],
          }),
          t.jsx('p', { className: 'mt-1 text-muted-foreground', children: t.jsx(o, { id: 'PyRW3c' }) }),
          t.jsx(m, { className: 'mt-4' }),
        ],
      }),
      t.jsx(i, {}),
    ],
...
export { Gt as meta, Ht as default };
