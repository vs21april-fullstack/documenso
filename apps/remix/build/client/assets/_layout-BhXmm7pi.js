import { H as f } from './app-header-mNnxroCH.js';
import { B as j } from './branding-logo-CADWdcfF.js';
import { B as n } from './button-Dm_JGgap.js';
import { C as N } from './chevron-left-BZCl9klZ.js';
import { O as c, w as d, d as l, L as m, r as p, i as u } from './chunk-KS7C4IRE-FYOnnPbz.js';
import { G as g } from './generic-error-layout-Ck6Ws6Ds.js';
import { T as o } from './index-CkOHfBoV.js';
import { j as r } from './jsx-runtime-DrYFQjIW.js';
import { a as b } from './meta-1txnm5en.js';
import { P as w } from './plus-C8JFN8md.js';
import { a as x } from './session-DJFUfUIe.js';
import { c as h } from './utils-C68LRSOY.js';
        ...
        children: [
          i
            ...
            : r.jsx('header', {
                ...
                children: r.jsxs('div', {
                  className: 'mx-auto flex w-full max-w-screen-xl items-center justify-between gap-x-4 px-4 md:px-8',
                  children: [
                    r.jsxs(m, {
                      to: '/',
                      className:
                        'rounded-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:inline',
                      children: [
                        r.jsx(j, { className: 'hidden h-6 w-auto sm:block' }),
                        r.jsx('img', {
                          src: v,
                          alt: 'Omni Sign Logo',
                          width: 48,
                    ...
                    r.jsxs('div', {
                      ...
                      children: [
                        r.jsxs('p', {
                          ...
                          children: [
                            r.jsx('span', { className: 'text-sm sm:hidden', children: r.jsx(o, { id: 'AVOxgl' }) }),
                            r.jsx('span', {
                              className: 'hidden text-sm sm:block',
                              children: r.jsx(o, { id: '0uqjes' }),
                            }),
                          ],
                        }),
                        r.jsx(n, {
                          ...
                          children: r.jsxs(m, {
                            ...
                            children: [
                              r.jsxs('div', {
                                ...
                                children: [r.jsx(w, { className: 'mr-1 h-5 w-5' }), r.jsx(o, { id: '1svIlj' })],
                              }),
                              r.jsx('span', { className: 'sm:hidden', children: r.jsx(o, { id: 'hYgDIe' }) }),
                            ],
                          }),
                        }),
                      ],
          ...
          r.jsx('main', { className: 'my-8 px-4 md:my-12 md:px-8', children: r.jsx(c, {}) }),
        ],
      })
    );
  }),
  $r = l(({ error: i }) => {
    const t = u(i) ? i.status : 500,
      s = { 404: { subHeading: { id: 'WZHDfC' }, heading: { id: 'udaO9j' }, message: { id: 'L9/hN3' } } };
    return r.jsx(g, {
      errorCode: t,
      errorCodeMap: s,
      secondaryButton: null,
      primaryButton: r.jsx(n, {
        asChild: !0,
        className: 'w-32',
        children: r.jsxs(m, {
          to: '/',
          children: [r.jsx(N, { className: 'mr-2 h-4 w-4' }), r.jsx(o, { id: 'sr0UJD' })],
        }),
      }),
    });
  });
export { $r as ErrorBoundary, Qr as meta, Xr as default };
