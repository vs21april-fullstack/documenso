import { w as l } from './chunk-KS7C4IRE-FYOnnPbz.js';
import { E as y } from './email-preferences-form-DSBYf-yD.js';
import { t as n } from './index-BbY_VZqi.js';
import { u as S } from './index-CkOHfBoV.js';
import { j as i } from './jsx-runtime-DrYFQjIW.js';
import { a as j } from './meta-1txnm5en.js';
import { u as d } from './organisation-Ylr4XBmr.js';
import { S as h } from './settings-header-C7I7HmzF.js';
import { S as f } from './spinner-CEVyI0yx.js';
...
const Et = l(() => {
  const { _: t } = S(),
    { toast: r } = x(),
    m = d(),
    { data: a, isLoading: s } = n.organisation.get.useQuery({ organisationReference: m.url }),
    { mutateAsync: e } = n.organisation.settings.update.useMutation(),
    p = async (u) => {
      try {
        const { emailId: o, emailReplyTo: c, emailDocumentSettings: g } = u;
        await e({ organisationId: m.id, data: { emailId: o, emailReplyTo: c || null, emailDocumentSettings: g } }),
          r({ title: t({ id: 'gpKzYy' }), description: t({ id: 'Y9wW3z' }) });
      } catch (o) {
        throw (r({ title: t({ id: 'ywDBfs' }), description: t({ id: 'U5E5kb' }), variant: 'destructive' }), o);
      }
    };
  return s || !a
    ? i.jsx(f, {})
    : i.jsxs('div', {
        className: 'max-w-2xl',
        children: [
          i.jsx(h, { title: t({ id: '0fzruQ' }), subtitle: t({ id: 'nBgiaO' }) }),
          i.jsx('section', {
            children: i.jsx(y, { canInherit: !1, settings: a.organisationGlobalSettings, onFormSubmit: p }),
          }),
        ],
      });
});
export { Et as default, wt as meta };
