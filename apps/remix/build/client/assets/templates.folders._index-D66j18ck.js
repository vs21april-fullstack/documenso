import { w as A, L as j, u as R, r } from './chunk-KS7C4IRE-FYOnnPbz.js';
import { b as B, c as G, a as N, d as Q, F as z } from './folder-card-DTbimfUG.js';
import { F } from './folder-type-ClqijYiN.js';
import { H as J, F as K } from './house-34YtrzSr.js';
import { t as $ } from './index-BbY_VZqi.js';
import { T as a, u as q } from './index-CkOHfBoV.js';
import { I as k } from './input-DdDbBJYb.js';
import { j as e } from './jsx-runtime-DrYFQjIW.js';
import { L as W } from './loader-circle-h5otgUzC.js';
import { a as X } from './meta-1txnm5en.js';
import { S as V } from './search-CRP2I58A.js';
import { a as U } from './team-BvmzkpNi.js';
import { b as v } from './teams-WAT4Ivvc.js';
...
const dt = A(() => {
  const { _: S } = q(),
    ...
    [L, c] = r.useState(null),
    [o, y] = r.useState(''),
    { data: i, isLoading: P } = $.folder.getFolders.useQuery({ type: F.TEMPLATE, parentId: f }),
    b = o.trim().toLowerCase(),
    O = (t) => t.name.toLowerCase().includes(b),
    u = i?.folders.filter(O) ?? [],
    h = u.filter((t) => t.pinned),
    I = u.filter((t) => !t.pinned),
    E = (i?.folders.length ?? 0) > 0,
    _ = u.length > 0,
    H = (t) => `${v(x.url)}/f/${t}`;
  return e.jsxs('div', {
    ...
    children: [
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            ...
            children: [
              e.jsxs(j, {
                ...
                children: [e.jsx(J, { className: 'mr-2 h-4 w-4' }), e.jsx(a, { id: 'i0qMbr' })],
              }),
              i?.breadcrumbs.map((t) =>
                e.jsxs(
                  'div',
                  {
                    ...
                    children: [
                      e.jsx('span', { className: 'px-3', children: '/' }),
                      e.jsxs(j, {
                        to: H(t.id),
                        className: 'flex items-center hover:text-muted-foreground/80',
                        children: [e.jsx(K, { className: 'mr-2 h-4 w-4' }), e.jsx('span', { children: t.name })],
                      }),
                    ],
                  },
                  t.id,
          ...
          e.jsx('div', {
            className: 'flex flex-col gap-y-4 sm:flex-row sm:justify-end sm:gap-x-4',
            children: e.jsx(z, { type: F.TEMPLATE, parentFolderId: f }),
          }),
        ],
      }),
      e.jsxs('div', {
        ...
        children: [
          e.jsx(V, { className: 'absolute top-9 left-2 h-4 w-4 text-muted-foreground' }),
          e.jsx(k, {
            placeholder: S({ id: 'rXrG+N' }),
            value: o,
      ...
      e.jsx('h1', {
        className: 'mt-4 truncate font-semibold text-2xl md:text-3xl',
        children: e.jsx(a, { id: 'S2sFOu' }),
      }),
      P
        ? e.jsx('div', {
            className: 'mt-6 flex justify-center',
            children: e.jsx(W, { className: 'h-8 w-8 animate-spin text-muted-foreground' }),
          })
        : e.jsxs(e.Fragment, {
            children: [
              h.length > 0 &&
                ...
                children: [
                  o &&
                    ...
                    e.jsx('div', {
                      ...
                      children: e.jsx(a, { id: 'ijHCDc', values: { searchTerm: o } }),
                    }),
                  !o &&
                    !E &&
                    e.jsx('div', {
                      className: 'mt-6 text-center text-muted-foreground',
                      children: e.jsx(a, { id: 'Mguhdv' }),
                    }),
                  e.jsx('div', {
...
export { dt as default, nt as meta };
