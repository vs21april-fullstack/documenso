import { ZCreateTemplateV2ResponseSchema, ZCreateTemplateV2RequestSchema } from '../../trpc/server/template-router/schema.js';
import { initContract } from '@ts-rest/core';
import { ZUnsuccessfulResponseSchema, ZSuccessfulFieldResponseSchema, ZDeleteFieldMutationSchema, ZUpdateFieldMutationSchema, ZSuccessfulFieldCreationResponseSchema, ZCreateFieldMutationSchema, ZSuccessfulRecipientResponseSchema, ZDeleteRecipientMutationSchema, ZUpdateRecipientMutationSchema, ZCreateRecipientMutationSchema, ZSuccessfulDocumentResponseSchema, ZDeleteDocumentMutationSchema, ZSuccessfulResendDocumentResponseSchema, ZResendDocumentForSigningMutationSchema, ZSuccessfulSigningResponseSchema, ZSendDocumentForSigningMutationSchema, ZGenerateDocumentFromTemplateMutationResponseSchema, ZGenerateDocumentFromTemplateMutationSchema, ZCreateDocumentFromTemplateMutationResponseSchema, ZCreateDocumentFromTemplateMutationSchema, ZSuccessfulGetTemplatesResponseSchema, ZGetTemplatesQuerySchema, ZSuccessfulGetTemplateResponseSchema, ZSuccessfulDeleteTemplateResponseSchema, ZNoBodyMutationSchema, ZCreateDocumentMutationResponseSchema, ZCreateDocumentMutationSchema, ZDownloadDocumentSuccessfulSchema, ZDownloadDocumentQuerySchema, ZSuccessfulGetDocumentResponseSchema, ZSuccessfulResponseSchema, ZGetDocumentsQuerySchema, ZAuthorizationHeadersSchema } from './schema.js';

const c = initContract();
const deprecatedDescription = 'This endpoint is deprecated, but will continue to be supported. For more details, see https://docs.documenso.com/developers/public-api.';
const ApiContractV1 = c.router({
  getDocuments: {
    method: 'GET',
