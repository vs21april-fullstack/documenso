 ...
 */
const BRANDING_CSS_MAX_LENGTH = 256 * 1024;
/**
 ...
 */
const BRANDING_LOGO_MAX_SIZE_MB = 5;
const BRANDING_LOGO_MAX_SIZE_BYTES = BRANDING_LOGO_MAX_SIZE_MB * 1024 * 1024;
const BRANDING_LOGO_ALLOWED_TYPES = ['image/jpeg', 'image/png', 'image/webp'];

export { BRANDING_CSS_MAX_LENGTH, BRANDING_LOGO_ALLOWED_TYPES, BRANDING_LOGO_MAX_SIZE_BYTES, BRANDING_LOGO_MAX_SIZE_MB };
