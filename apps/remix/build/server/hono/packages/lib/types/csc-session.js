 ...
 * CSC v1.0.4.0 §11.9.
 */
const ZCscSessionItemSchema = z.object({
 ...
 * recipient.
 */
const ZCscSessionItemsSchema = z.array(ZCscSessionItemSchema);

export { ZCscSessionItemSchema, ZCscSessionItemsSchema };
//# sourceMappingURL=csc-session.js.map
