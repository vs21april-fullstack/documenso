 ...
 */
const CSS_LENGTH_REGEX = /^(0|\d+(\.\d+)?(rem|px|em|%|pt|))$/i;
const ZCssVarsSchema = z.object({
  ...
  radius: z.string().regex(CSS_LENGTH_REGEX, 'Must be a CSS length such as 0.5rem, 8px, or 0').optional().describe('Border radius — must be a CSS length (rem/px/em/%/pt or 0)'),
...
export { CSS_LENGTH_REGEX, ZCssVarsSchema };
