 ...
 * Example: "5m", "1h", "1d"
 */
const RATE_LIMIT_WINDOW_REGEX = /^\d+[smhd]$/;
...
const ZRateLimitWindowSchema = z.string().trim().regex(RATE_LIMIT_WINDOW_REGEX, {
  message: RATE_LIMIT_WINDOW_ERROR_MESSAGE
});
const ZRateLimitArraySchema = z.array(z.object({
 ...
 */
const ZClaimFlagsSchema = z.object({
  /**
...
const SUBSCRIPTION_CLAIM_FEATURE_FLAGS = {
  unlimitedDocuments: {
...
var INTERNAL_CLAIM_ID;
(function (INTERNAL_CLAIM_ID) {
  INTERNAL_CLAIM_ID["FREE"] = "free";
  INTERNAL_CLAIM_ID["INDIVIDUAL"] = "individual";
  INTERNAL_CLAIM_ID["TEAM"] = "team";
  INTERNAL_CLAIM_ID["EARLY_ADOPTER"] = "earlyAdopter";
  INTERNAL_CLAIM_ID["PLATFORM"] = "platform";
  INTERNAL_CLAIM_ID["ENTERPRISE"] = "enterprise";
...
export { INTERNAL_CLAIM_ID, RATE_LIMIT_WINDOW_REGEX, SUBSCRIPTION_CLAIM_FEATURE_FLAGS, ZClaimFlagsSchema, ZRateLimitArraySchema, ZRateLimitWindowSchema, internalClaims };
