...
const hasInvalidCharacter = value => INVALID_CHARACTER_REGEX.test(value);
/**
...
const hasInvalidEscapeSequence = value => {
...
const hasInvalidTextCharacters = value => hasInvalidCharacter(value) || hasInvalidEscapeSequence(value);
/**
 ...
 */
const ZNameSchema = z.string().trim().min(2, {
...
export { URL_PATTERN, ZNameSchema, hasInvalidTextCharacters };
