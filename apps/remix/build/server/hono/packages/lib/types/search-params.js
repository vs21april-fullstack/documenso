 ...
 */
const ZFindSearchParamsSchema = z.object({
...
z.object({
  ...
  perPage: z.coerce.number().min(1).max(100).optional().catch(() => undefined)
});
const ZFindResultResponse = z.object({
...
export { ZFindResultResponse, ZFindSearchParamsSchema };
