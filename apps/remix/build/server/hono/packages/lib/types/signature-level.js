 ...
 */
const ZSignatureLevelSchema = z.enum(['SES', 'AES', 'QES']);
const SignatureLevel = ZSignatureLevelSchema.enum;
/**
 ...
 */
const isTspEnvelope = envelope => envelope.signatureLevel === SignatureLevel.AES || envelope.signatureLevel === SignatureLevel.QES;

export { SignatureLevel, ZSignatureLevelSchema, isTspEnvelope };
//# sourceMappingURL=signature-level.js.map
