import { numberFormatValues } from '../../ui/primitives/document-flow/field-items-advanced-settings/constants.js';

const validateNumberField = (value, fieldMeta, isSigningPage = false) => {
  const errors = [];
  const {
    minValue,
    maxValue,
