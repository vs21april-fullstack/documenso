...
const calculateLayout = params => {
  ...
  return {
    exceedsWidth,
    exceedsHeightWhenWrapped,
    hasRoomForMoreThanOneLine
  };
};
/**
 ...
 */
const calculateHorizontalOverflow = params => {
  const {
    textAlign,
    baseX,
    baseY,
 ...
 */
const calculateVerticalOverflow = params => {
  const {
    verticalAlign,
    textAlign,
    baseX,
 ...
 */
const calculateOverflowLayout = params => {
  const {
    overflowMode,
    isLabel,
    baseX,
...
export { calculateOverflowLayout };
//# sourceMappingURL=calculate-overflow-layout.js.map
