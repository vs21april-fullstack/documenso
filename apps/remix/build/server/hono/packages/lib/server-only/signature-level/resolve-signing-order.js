...
import { assertCompatibleSigningOrder } from './assert-compatible-signing-order.js';
...
const resolveSigningOrder = ({
  ...
  if (requested) {
    assertCompatibleSigningOrder({
      signatureLevel,
      signingOrder: requested
    });
    return requested;
  }
  return isTspEnvelope({
    signatureLevel
  }) ? DocumentSigningOrder.SEQUENTIAL : DocumentSigningOrder.PARALLEL;
};

export { resolveSigningOrder };
//# sourceMappingURL=resolve-signing-order.js.map
