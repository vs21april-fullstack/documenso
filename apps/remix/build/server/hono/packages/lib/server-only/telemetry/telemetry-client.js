...
import { getSiteSetting } from '../site-settings/get-site-setting.js';
import { SITE_SETTINGS_TELEMETRY_ID } from '../site-settings/schemas/telemetry.js';
import { upsertSiteSetting } from '../site-settings/upsert-site-setting.js';
...
class TelemetryClient {
  ...
  static async start() {
    if (TELEMETRY_DISABLED) {
      if (!HAS_LICENSE_KEY) {
        console.log('[Telemetry] Telemetry is disabled. To enable, remove the DOCUMENSO_DISABLE_TELEMETRY environment variable.');
      }
      return;
    }
