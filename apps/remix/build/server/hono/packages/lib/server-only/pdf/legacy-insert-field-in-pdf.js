import { RotationTypes, radiansToDegrees, degrees, rgb } from '@cantoo/pdf-lib';
...
const legacy_insertFieldInPDF = async (pdf, field) => {
  ...
  await match(field).with({
    ...
    const Parser = fieldMetaParsers[field.type];
...
export { legacy_insertFieldInPDF };
//# sourceMappingURL=legacy-insert-field-in-pdf.js.map
