...
import { DOCUMENT_CONVERSION_URL, DOCUMENT_CONVERSION_MIME_TYPE_DOCX, DOCUMENT_CONVERSION_AUTH, DOCUMENT_CONVERSION_TIMEOUT_MS } from '../../constants/document-conversion.js';
...
const CONVERSION_FAILED_USER_MESSAGE = "We couldn't convert this file. Please check it's a valid Word document or upload a PDF instead.";
 ...
 */
const convertDocxToPdfViaGotenberg = async ({
  buffer,
  filename
}) => {
...
export { convertDocxToPdfViaGotenberg };
