...
const setFieldsForTemplate = async ({
  userId,
  teamId,
  id,
  fields
  ...
  linkedFields.map(async field => {
    ...
    const upsertedField = await prismaWithReplicas.field.upsert({
      where: {
  ...
  if (removedFields.length > 0) {
    await prismaWithReplicas.field.deleteMany({
      where: {
        id: {
...
export { setFieldsForTemplate };
//# sourceMappingURL=set-fields-for-template.js.map
