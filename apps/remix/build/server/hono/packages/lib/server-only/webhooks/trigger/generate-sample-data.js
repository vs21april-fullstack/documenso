import { SendStatus, SigningStatus, ReadStatus, RecipientRole, DocumentDistributionMethod, DocumentSigningOrder, DocumentSource, DocumentStatus, DocumentVisibility, WebhookTriggerEvents } from '@prisma/client';

const generateSampleWebhookPayload = (event, webhookUrl) => {
  const now = new Date();
  const basePayload = {
    id: 10,
    envelopeId: 'env_123',
...
export { generateSampleWebhookPayload };
