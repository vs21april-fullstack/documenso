import { ZEnvelopeFieldAndMetaSchema } from '../../types/field-meta.js';
import { PDF, rgb } from '@libpdf/core';
import { parseFieldTypeFromPlaceholder, parseFieldMetaFromPlaceholder } from './helpers.js';
 ...
 */
const whiteoutRegions = (pdfDoc, regions) => {
...
const extractPlaceholdersFromPDF = async pdf => {
  ...
  for (const page of pdfDoc.getPages()) {
    ...
    for (const match of matches) {
      ...
      */
      ...
      const fieldAndMeta = ZEnvelopeFieldAndMetaSchema.parse({
        type: fieldType,
 ...
 */
const removePlaceholdersFromPDF = async (pdf, placeholders) => {
 ...
 */
const extractPdfPlaceholders = async pdf => {
 ...
 */
const convertPlaceholdersToFieldInputs = (placeholders, recipientResolver, envelopeItemId) => {
...
export { convertPlaceholdersToFieldInputs, extractPdfPlaceholders, extractPlaceholdersFromPDF, removePlaceholdersFromPDF, whiteoutRegions };
//# sourceMappingURL=auto-place-fields.js.map
