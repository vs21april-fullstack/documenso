...
const EXPIRE_RECIPIENTS_SWEEP_JOB_DEFINITION = {
  ...
  handler: async ({
    ...
    const handler = await import('./expire-recipients-sweep.handler.js');
    await handler.run({
      payload,
      io
    });
...
export { EXPIRE_RECIPIENTS_SWEEP_JOB_DEFINITION };
//# sourceMappingURL=expire-recipients-sweep.js.map
