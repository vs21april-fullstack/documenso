...
const SEND_DOCUMENT_DELETED_EMAILS_JOB_DEFINITION = {
  ...
  handler: async ({
    ...
    const handler = await import('./send-document-deleted-emails.handler.js');
    await handler.run({
      payload,
      io
    });
...
export { SEND_DOCUMENT_DELETED_EMAILS_JOB_DEFINITION };
//# sourceMappingURL=send-document-deleted-emails.js.map
