import { BulkSendCompleteEmail } from '../../../../email/templates/bulk-send-complete.js';
import { sendDocument } from '../../../server-only/document/send-document.js';
import { createDocumentFromTemplate } from '../../../server-only/template/create-document-from-template.js';
import { getTemplateById } from '../../../server-only/template/get-template-by-id.js';
...
const run = async ({
  ...
  await io.runTask('send-completion-email', async () => {
    const completionTemplate = /*#__PURE__*/createElement(BulkSendCompleteEmail, {
...
export { run };
//# sourceMappingURL=bulk-send-template.handler.js.map
