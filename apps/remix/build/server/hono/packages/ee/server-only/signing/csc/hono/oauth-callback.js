...
import { z } from 'zod';
import { resolveCscAlgorithmPolicy } from '../algorithm-resolver.js';
import { encodeCscCertChain } from '../cert-chain.js';
import { encryptCscToken } from '../ciphers.js';
import { cscCredentialsList, cscCredentialsInfo } from '../client/credentials.js';
import { exchangeCscAuthorizationCode } from '../client/oauth.js';
import { setCscBlockingErrorCookie } from '../cookies/blocking-error-cookie.js';
import { getCscOAuthFlowCookie, clearCscOAuthFlowCookie } from '../cookies/oauth-flow-cookie.js';
import { setCscSadSessionCookie } from '../cookies/sad-session-cookie.js';
import { setCscServiceSessionCookie } from '../cookies/service-session-cookie.js';
import { upsertCscCredential, loadCscCredential } from '../credential.js';
import { updateCscSessionWithSad } from '../sign-session.js';
...
const BLOCKING_SERVICE_ERROR_CODES = new Set([AppErrorCode.CSC_CREDENTIAL_LIST_EMPTY, AppErrorCode.CSC_CERT_INVALID, AppErrorCode.CSC_ALGORITHM_REFUSED]);
const isBlockingServiceError = code => BLOCKING_SERVICE_ERROR_CODES.has(code);
const cscOAuthCallbackRoute = new Hono().get('/', sValidator('query', ZCallbackQuerySchema), async c => {
