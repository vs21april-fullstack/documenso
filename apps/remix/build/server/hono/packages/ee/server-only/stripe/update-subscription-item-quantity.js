...
import { isPriceSeatsBased } from './is-price-seats-based.js';
 ...
 */
const assertMemberCountWithinCap = async (subscription, organisationClaim, quantity) => {
 ...
 */
const syncMemberCountWithStripeSeatPlan = async (subscription, organisationClaim, quantity) => {
...
export { assertMemberCountWithinCap, syncMemberCountWithStripeSeatPlan, updateSubscriptionItemQuantity };
//# sourceMappingURL=update-subscription-item-quantity.js.map
