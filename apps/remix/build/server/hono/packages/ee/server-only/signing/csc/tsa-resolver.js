...
import { CscTspTimestampAuthority } from './tsp-timestamp-authority.js';
 ...
 */
const resolveCscSignTimeTsa = (transport, serviceToken) => {
  if (transport.supportsTimestamp) {
    return new CscTspTimestampAuthority({
      transport,
      serviceToken
    });
  }
  ...
  throw new AppError(AppErrorCode.CSC_PROVIDER_NO_TSA, {
    message: 'CSC sign-time TSA unresolved: TSP does not advertise signatures/timestamp and NEXT_PRIVATE_SIGNING_TIMESTAMP_AUTHORITY is unset. This should have been caught by the boot-time guard in buildCscTransport.'
  });
};
/**
...
export { isEnvTsaConfigured, resolveCscSealTimeTsa, resolveCscSignTimeTsa };
//# sourceMappingURL=tsa-resolver.js.map
