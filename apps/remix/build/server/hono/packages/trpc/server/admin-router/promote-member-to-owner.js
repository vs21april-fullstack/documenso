...
import { ZPromoteMemberToOwnerRequestSchema, ZPromoteMemberToOwnerResponseSchema } from './promote-member-to-owner.types.js';

const promoteMemberToOwnerRoute = adminProcedure.input(ZPromoteMemberToOwnerRequestSchema).output(ZPromoteMemberToOwnerResponseSchema).mutation(async ({
  input,
  ctx
}) => {
  const {
...
export { promoteMemberToOwnerRoute };
//# sourceMappingURL=promote-member-to-owner.js.map
