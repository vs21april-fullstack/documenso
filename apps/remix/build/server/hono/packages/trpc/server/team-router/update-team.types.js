...
const MAX_PROFILE_BIO_LENGTH = 256;
...
//   },
// };
const ZUpdateTeamRequestSchema = z.object({
  teamId: z.number(),
  data: z.object({
    name: ZNameSchema.optional(),
    url: ZTeamUrlSchema.optional(),
    profileBio: z.string().max(MAX_PROFILE_BIO_LENGTH, {
      message: `Bio must be shorter than ${MAX_PROFILE_BIO_LENGTH + 1} characters`
    }).optional(),
    profileEnabled: z.boolean().optional()
  })
});
const ZUpdateTeamResponseSchema = z.void();

export { MAX_PROFILE_BIO_LENGTH, ZUpdateTeamRequestSchema, ZUpdateTeamResponseSchema };
//# sourceMappingURL=update-team.types.js.map
