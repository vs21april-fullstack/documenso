...
import { ZDeleteAdminOrganisationMemberRequestSchema, ZDeleteAdminOrganisationMemberResponseSchema } from './delete-organisation-member.types.js';

const deleteAdminOrganisationMemberRoute = adminProcedure.input(ZDeleteAdminOrganisationMemberRequestSchema).output(ZDeleteAdminOrganisationMemberResponseSchema).mutation(async ({
  ctx,
  input
}) => {
  const {
  ...
  if (organisation.subscription) {
    await syncMemberCountWithStripeSeatPlan(organisation.subscription, organisation.organisationClaim, newMemberCount);
  }
...
export { deleteAdminOrganisationMemberRoute };
