import { isBase64Image } from '../../../lib/constants/signatures.js';
import { AppError, AppErrorCode } from '../../../lib/errors/app-error.js';
import { validateFieldAuth } from '../../../lib/server-only/document/validate-field-auth.js';
...
import { extractFieldInsertionValues } from '../../../lib/utils/envelope-signing.js';
import { prisma as prismaWithReplicas } from '../../../prisma/index.js';
import { SigningStatus, RecipientRole, FieldType, DocumentStatus } from '@prisma/client';
import { match } from 'ts-pattern';
import { procedure } from '../trpc.js';
import { ZSignEnvelopeFieldRequestSchema, ZSignEnvelopeFieldResponseSchema } from './sign-envelope-field.types.js';

// Note that this is an unauthenticated public procedure route.
const signEnvelopeFieldRoute = procedure.input(ZSignEnvelopeFieldRequestSchema).output(ZSignEnvelopeFieldResponseSchema).mutation(async ({
  input,
  ctx
}) => {
  const {
...
export { signEnvelopeFieldRoute };
//# sourceMappingURL=sign-envelope-field.js.map
