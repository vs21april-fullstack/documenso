...
import { ZUpdateEmbeddingDocumentRequestSchema, ZUpdateEmbeddingDocumentResponseSchema } from './update-embedding-document.types.js';
import { nanoid } from 'nanoid';

const updateEmbeddingDocumentRoute = procedure.input(ZUpdateEmbeddingDocumentRequestSchema).output(ZUpdateEmbeddingDocumentResponseSchema).mutation(async ({
  input,
  ctx
}) => {
  ctx.logger.info({
...
export { updateEmbeddingDocumentRoute };
//# sourceMappingURL=update-embedding-document.js.map
