...
import { ZBulkCancelEnvelopesRequestSchema, ZBulkCancelEnvelopesResponseSchema } from './bulk-cancel-envelopes.types.js';

const bulkCancelEnvelopesRoute = authenticatedProcedure.input(ZBulkCancelEnvelopesRequestSchema).output(ZBulkCancelEnvelopesResponseSchema).mutation(async ({
  input,
  ctx
}) => {
  const {
...
export { bulkCancelEnvelopesRoute };
//# sourceMappingURL=bulk-cancel-envelopes.js.map
