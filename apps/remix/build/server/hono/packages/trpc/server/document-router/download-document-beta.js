...
import { getPresignGetUrl } from '../../../lib/universal/upload/server-actions.js';
import { isDocumentCompleted } from '../../../lib/utils/document.js';
import { EnvelopeType, DocumentDataType, DocumentStatus } from '@prisma/client';
import { authenticatedProcedure } from '../trpc.js';
import { downloadDocumentMeta, ZDownloadDocumentRequestSchema, ZDownloadDocumentResponseSchema } from './download-document-beta.types.js';

const downloadDocumentBetaRoute = authenticatedProcedure.meta(downloadDocumentMeta).input(ZDownloadDocumentRequestSchema).output(ZDownloadDocumentResponseSchema).query(async ({
  input,
  ctx
}) => {
  const {
...
export { downloadDocumentBetaRoute };
//# sourceMappingURL=download-document-beta.js.map
