...
import { ZCreateEmbeddingDocumentRequestSchema, ZCreateEmbeddingDocumentResponseSchema } from './create-embedding-document.types.js';

// Todo: Envelopes - This only supports V1 documents/templates.
const createEmbeddingDocumentRoute = procedure.input(ZCreateEmbeddingDocumentRequestSchema).output(ZCreateEmbeddingDocumentResponseSchema).mutation(async ({
  input,
  ctx: {
    req,
    metadata
...
export { createEmbeddingDocumentRoute };
//# sourceMappingURL=create-embedding-document.js.map
