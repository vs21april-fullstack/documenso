import { getSession } from '../../../packages/auth/server/lib/utils/get-session.js';
import { IS_AI_FEATURES_CONFIGURED } from '../../../packages/lib/constants/app.js';
import { AppError, AppErrorCode } from '../../../packages/lib/errors/app-error.js';
import { detectRecipientsFromEnvelope } from '../../../packages/lib/server-only/ai/envelope/detect-recipients/index.js';
import { getTeamById } from '../../../packages/lib/server-only/team/get-team.js';
import { sValidator } from '@hono/standard-validator';
import { Hono } from 'hono';
import { streamText } from 'hono/streaming';
import { ZDetectRecipientsRequestSchema } from './detect-recipients.types.js';

const KEEPALIVE_INTERVAL_MS = 5000;
const detectRecipientsRoute = new Hono().post('/', sValidator('json', ZDetectRecipientsRequestSchema), async c => {
  ...
  try {
    ...
    return streamText(c, async stream => {
      ...
      let interval = setInterval(() => {
        void stream.writeln(JSON.stringify({
          type: 'keepalive'
        }));
    ...
    return c.json({
      error: 'Failed to detect recipients'
    }, 500);
  }
});

export { detectRecipientsRoute };
//# sourceMappingURL=detect-recipients.js.map
