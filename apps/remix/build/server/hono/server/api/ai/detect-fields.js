...
import { detectFieldsFromEnvelope } from '../../../packages/lib/server-only/ai/envelope/detect-fields/index.js';
import { getTeamById } from '../../../packages/lib/server-only/team/get-team.js';
import { sValidator } from '@hono/standard-validator';
import { Hono } from 'hono';
import { streamText } from 'hono/streaming';
import { ZDetectFieldsRequestSchema } from './detect-fields.types.js';

const KEEPALIVE_INTERVAL_MS = 5000;
const detectFieldsRoute = new Hono().post('/', sValidator('json', ZDetectFieldsRequestSchema), async c => {
...
export { detectFieldsRoute };
//# sourceMappingURL=detect-fields.js.map
