...
import { T as TemplateBrandingLogo } from './template-branding-logo-VNUnWkTL.js';
...
} from './update-recipient-next-reminder-CFInLTYm.js';
import 'node:stream';
import 'zod';
import '@lingui/core';
...
const TemplateDocumentReminder = ({ recipientName, documentName, signDocumentLink, assetBaseUrl, role }) => {
  const { _ } = useLingui();
                ...
                /* @__PURE__ */ jsx(Container, {
                  ...
                  children: /* @__PURE__ */ jsx(Section, {
                    children: /* @__PURE__ */ jsx(Text, {
                      ...
                      children: /* @__PURE__ */ jsx(TemplateCustomMessageBody, { text: customBody }),
                    }),
                  }),
                }),
