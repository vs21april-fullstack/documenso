import { T as TemplateFooter, r as renderEmailWithI18N, m as mailer } from "./render-email-with-i18n-BE-sB8kf.js";
...
import { m as env, p as prismaWithReplicas, N as NEXT_PUBLIC_WEBAPP_URL } from "./server-build-p5av3CDS.js";
...
const TemplateResetPassword = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Section, { className: "flex-row items-center justify-center", children: [
      ...
      /* @__PURE__ */ jsx(Section, { className: "mt-8 mb-6 text-center", children: /* @__PURE__ */ jsx(Button, { className: "inline-flex items-center justify-center rounded-lg bg-primary px-6 py-3 text-center font-medium text-primary-foreground text-sm no-underline", href: `${NEXT_PUBLIC_WEBAPP_URL2 ?? "http://localhost:3000"}/signin`, children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
      {
        id: "n1ekoW"
      } }) }) })
    ] })
    ...
    /* @__PURE__ */ jsxs(Body, { className: "mx-auto my-auto bg-background font-sans", children: [
      ...
      /* @__PURE__ */ jsxs(Section, { children: [
        ...
        /* @__PURE__ */ jsx(Container, { className: "mx-auto mt-12 max-w-xl", children: /* @__PURE__ */ jsxs(Section, { children: [
          /* @__PURE__ */ jsx(Text, { className: "my-4 font-semibold text-base", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
          {
            id: "neKtDP",
            values: {
              userName,
            ...
            components: {
              0: /* @__PURE__ */ jsx(Link, { className: "font-normal text-muted-foreground", href: `mailto:${userEmail}` })
            }
          } }) }),
          /* @__PURE__ */ jsx(Text, { className: "mt-2 text-base text-muted-foreground", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
          {
            id: "6yoqQD"
          } }) }),
          /* @__PURE__ */ jsx(Text, { className: "mt-2 text-base text-muted-foreground", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
          {
            id: "7wRHVd",
            components: {
              0: /* @__PURE__ */ jsx(Link, { className: "font-normal text-primary", href: "mailto:hi@documenso.com" })
            }
          } }) })
        ] }) }),
