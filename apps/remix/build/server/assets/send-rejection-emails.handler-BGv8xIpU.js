import { T as TemplateFooter, g as getI18nInstance, r as renderEmailWithI18N, m as mailer } from "./render-email-with-i18n-xTxBG7xG.js";
...
import { p as prismaWithReplicas, e as unsafeBuildEnvelopeIdQuery, f as extractDerivedDocumentEmailSettings, i as isRecipientEmailValidForSending, N as NEXT_PUBLIC_WEBAPP_URL, k as formatDocumentsPath, D as DOCUMENSO_INTERNAL_EMAIL } from "./server-build-BldIODWZ.js";
...
function TemplateDocumentRejected({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
    /* @__PURE__ */ jsx(Heading, { className: "mb-4 text-center font-semibold text-2xl text-foreground", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "0aBbNe"
    } }) }),
    /* @__PURE__ */ jsx(Text, { className: "mb-4 text-base", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "A/uN4T",
      values: {
        signerName,
    ...
    rejectionReason && /* @__PURE__ */ jsx(Text, { className: "mb-4 text-base text-muted-foreground", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "/ts7bl",
      values: {
        rejectionReason
    ...
    /* @__PURE__ */ jsx(Text, { className: "mb-6 text-base", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "Y32cFr"
    } }) }),
    /* @__PURE__ */ jsx(Button, { href: documentUrl, className: "inline-flex items-center justify-center rounded-lg bg-primary px-6 py-3 text-center font-medium text-primary-foreground text-sm no-underline", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "SzshGx"
    } }) })
  ] });
    ...
    /* @__PURE__ */ jsxs(Body, { className: "mx-auto my-auto bg-background font-sans", children: [
      ...
      /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(Container, { className: "mx-auto mt-8 mb-2 max-w-xl rounded-lg border border-border border-solid p-4 backdrop-blur-sm", children: /* @__PURE__ */ jsxs(Section, { children: [
          ...
          /* @__PURE__ */ jsx(TemplateDocumentRejected, { recipientName, documentName, documentUrl, rejectionReason })
        ] }) }),
...
function TemplateDocumentRejectionConfirmed({
  ...
  return /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(Heading, { className: "font-semibold text-2xl", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "j4Qqya"
    } }) }),
    /* @__PURE__ */ jsx(Text, { className: "text-base text-foreground", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "RzMPvz",
      values: {
        documentName,
    ...
    reason && /* @__PURE__ */ jsx(Text, { className: "font-medium text-base text-muted-foreground", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "Vb19fD",
      values: {
        reason
    ...
    /* @__PURE__ */ jsx(Text, { className: "text-base", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "jOxq1z"
    } }) })
  ] }) });
  ...
  return /* @__PURE__ */ jsxs(Html, { children: [
    ...
    /* @__PURE__ */ jsxs(Body, { className: "mx-auto my-auto bg-background font-sans", children: [
      ...
      /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(Container, { className: "mx-auto mt-8 mb-2 max-w-xl rounded-lg border border-border border-solid p-4 backdrop-blur-sm", children: /* @__PURE__ */ jsxs(Section, { children: [
          /* @__PURE__ */ jsx(TemplateBrandingLogo, { assetBaseUrl, className: "mb-4 h-6" }),
          /* @__PURE__ */ jsx(TemplateDocumentRejectionConfirmed, { recipientName, documentName, documentOwnerName, reason })
        ] }) }),
        /* @__PURE__ */ jsx(Container, { className: "mx-auto max-w-xl", children: /* @__PURE__ */ jsx(TemplateFooter, {}) })
      ] })
    ] })
