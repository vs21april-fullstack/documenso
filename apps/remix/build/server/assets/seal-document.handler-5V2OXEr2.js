...
import { ap as NEXT_PRIVATE_SIGNING_TIMESTAMP_AUTHORITY, w as AppError, x as AppErrorCode, h as getFileServerSide, aq as putPdfFileServerSide, p as prismaWithReplicas, ar as NEXT_PRIVATE_INTERNAL_WEBAPP_URL, as as DOCUMENT_STATUS, A as APP_I18N_OPTIONS, R as RECIPIENT_ROLES_DESCRIPTION, at as formatDocumentAuditLogAction, m as DOCUMENT_AUDIT_LOG_TYPE, au as ZSupportedLanguageCodeSchema, av as getOrganisationClaimByTeamId, aw as getTranslations, ax as parseDocumentAuditLogData, N as NEXT_PUBLIC_WEBAPP_URL, ay as svgToPng, az as getSignatureFontFamily, aA as RECIPIENT_ROLE_SIGNING_REASONS, aB as getDocumentCertificateAuditLogs, a1 as extractDocumentAuthMethods, aC as PDF_SIZE_A4_72PPI, n as env, aD as NEXT_PRIVATE_USE_LEGACY_SIGNING_SUBFILTER, aE as NEXT_PUBLIC_SIGNING_CONTACT_INFO, aF as encryptSecondaryData, o as isValidLanguageCode, aG as USE_INTERNAL_URL_BROWSERLESS, aH as isSignatureFieldType, aI as DEFAULT_HANDWRITING_FONT_SIZE, aJ as DEFAULT_STANDARD_FONT_SIZE, aK as MIN_HANDWRITING_FONT_SIZE, aL as MIN_STANDARD_FONT_SIZE, ah as ZCheckboxFieldMeta, aM as fromCheckboxValue, ag as ZRadioFieldMeta, aN as ZInitialsFieldMeta, aO as ZNameFieldMeta, aP as ZEmailFieldMeta, aQ as ZDateFieldMeta, aR as ZNumberFieldMeta, aS as ZTextFieldMeta, aT as renderField, M as mapDocumentIdToSecondaryId, a0 as getTeamSettings, aU as fieldsContainUnsignedRequiredField, a7 as prefixedId, l as createDocumentAuditLogData, aV as isTspEnvelope, aW as NEXT_PRIVATE_USE_PLAYWRIGHT_PDF, ad as triggerWebhook, ae as ZWebhookDocumentSchema, af as mapEnvelopeToWebhookDocumentPayload, aX as isDocumentCompleted } from "./server-build-CEznbUHz.js";
...
const run = async ({
  ...
  if (shouldSendCompletedEmail) {
    await io.runTask("send-document-completed-emails", async () => {
      const completedEmailHandler = await import("./send-document-completed-emails.handler-ZY9WHQDx.js");
