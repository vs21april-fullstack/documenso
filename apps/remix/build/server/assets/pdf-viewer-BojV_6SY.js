...
import { S as Spinner, c as cn, u as useToast, P as PdfViewerLoadingState, a as PdfViewerErrorState, b as PDF_VIEWER_PAGE_CLASSNAME } from "./server-build-Iwbpv6Jl.js";
...
import "stripe";
import "jose";
const pdfjsWorker = "/assets/pdf.worker-9aISQa3R.mjs";
const useVirtualList = (options) => {
  ...
  const findStartIndex = useCallback((scrollTop2) => {
    let low = 0;
...
const PdfViewerPageImage = ({
  imageLoadingState,
  imageProps
}) => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    imageLoadingState === "loading" && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-10 flex items-center justify-center text-muted-foreground opacity-20", children: /* @__PURE__ */ jsx(Spinner, {}) }),
    imageLoadingState === "error" && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-10 flex items-center justify-center", children: /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "PRRaD1"
    } }) }) }),
    imageProps.src && /* @__PURE__ */ jsx("img", { ...imageProps, className: cn(imageProps.className, "select-none"), draggable: false, alt: "" })
  ] });
};
...
function PDFViewer({
  ...
  useEffect(() => {
    ...
    const fetchMetadata = async () => {
      try {
        ...
        const pages2 = await pMap(Array.from({
  ...
  if (!data) {
    return /* @__PURE__ */ jsx("div", { ref: $el, className: cn("h-full w-full", className), ...props, children: /* @__PURE__ */ jsx("p", { className: "py-32 text-center text-muted-foreground text-sm", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "i1ibmE"
    } }) }) });
  }
  return /* @__PURE__ */ jsxs("div", { ref: $el, className: cn("h-full w-full", className), ...props, children: [
    isLoading && /* @__PURE__ */ jsx(PdfViewerLoadingState, {}),
    hasError && /* @__PURE__ */ jsx(PdfViewerErrorState, {}),
    loadingState === "loaded" && pages.length > 0 && pdfRef.current && /* @__PURE__ */ jsx(VirtualizedPageList, { scrollParentRef, constraintRef: $el, numPages: pages.length, pages, pdf: pdfRef.current, customPageRenderer })
  ] });
}
    ...
    "div",
    {
      ...
      children: virtualItems.map((virtualItem) => {
        ...
        return /* @__PURE__ */ jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsx(PdfViewerPage, { unscaledWidth: pageMeta.width, unscaledHeight: pageMeta.height, scaledWidth, scaledHeight, pageNumber, pdf, scale, customPageRenderer }),
          /* @__PURE__ */ jsx("p", { className: "my-2 text-center text-[11px] text-muted-foreground/80", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
          {
            id: "wQQdcH",
            values: {
              pageNumber,
...
const PdfViewerPage = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative w-full rounded border border-border", style: {
    width: scaledWidth,
    height: scaledHeight
  }, children: [
    CustomPageRenderer && imageLoadingState === "loaded" && /* @__PURE__ */ jsx(CustomPageRenderer, { pageData: {
      scale,
...
const usePdfPageImage = ({
  ...
  useEffect(() => {
    ...
    const hasMatchingRenderedImage = (resolution) => {
      return renderedPdfRef.current === pdf && renderedPageNumberRef.current === pageNumber && renderedResolutionRef.current === resolution;
    };
