...
const run = async ({
  ...
  if (shouldSendCompletedEmail) {
    await io.runTask("send-document-completed-emails", async () => {
      const completedEmailHandler = await import("./send-document-completed-emails.handler-BIvblBgx.js");
