import { T as TemplateFooter, r as renderEmailWithI18N, g as getI18nInstance, m as mailer } from "./render-email-with-i18n-BRzbz_v3.js";
import { jsxs, jsx } from "react/jsx-runtime";
import { y as SUPPORT_EMAIL, p as prismaWithReplicas, z as ORGANISATION_MEMBER_ROLE_PERMISSIONS_MAP, B as INTERNAL_CLAIM_ID, N as NEXT_PUBLIC_WEBAPP_URL, D as DOCUMENSO_INTERNAL_EMAIL } from "./server-build-DZjqD4tR.js";
      ...
      /* @__PURE__ */ jsxs(Section, { className: "bg-background text-muted-foreground", children: [
        /* @__PURE__ */ jsxs(Container, { className: "mx-auto mt-8 mb-2 max-w-xl rounded-lg border border-border border-solid p-2 backdrop-blur-sm", children: [
          ...
          /* @__PURE__ */ jsxs(Section, { className: "p-2 text-muted-foreground", children: [
            /* @__PURE__ */ jsx(Text, { className: "text-center font-medium text-foreground text-lg", children: kind === "quotaNearing" ? /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
              id: "2RtWIH"
            ...
            /* @__PURE__ */ jsx("div", { className: "mx-auto my-2 w-fit rounded-lg bg-muted px-4 py-2 font-medium text-base text-muted-foreground", children: organisationName }),
            match(kind).with("quota", () => /* @__PURE__ */ jsx(Text, { className: "text-center text-base", children: match(counter).with("document", () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
              id: "ae1E1d"
            } })).with("email", () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
              id: "ocEsla"
            } })).with("api", () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
              id: "EdVPC8"
            } })).exhaustive() })).with("rateLimit", () => /* @__PURE__ */ jsx(Text, { className: "text-center text-base", children: match(counter).with("document", () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
              id: "4AfIg0"
            } })).with("email", () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
            ...
            {
              id: "24Ci00"
            } })).exhaustive() })).with("quotaNearing", () => /* @__PURE__ */ jsx(Text, { className: "text-center text-base", children: match(counter).with("document", () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
              id: "rhkxlS"
            } })).with("email", () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
            ...
            /* @__PURE__ */ jsx(Text, { className: "text-center text-base", children: kind === "quotaNearing" ? /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
              id: "0mb9Jt",
              values: {
                SUPPORT_EMAIL
