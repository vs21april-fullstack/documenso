...
import { T as TemplateFooter, r as renderEmailWithI18N, g as getI18nInstance } from "./render-email-with-i18n-CWPWjjEZ.js";
import { T as TemplateImage } from "./template-image-BBICzxvn.js";
import { p as prismaWithReplicas, z as ORGANISATION_MEMBER_ROLE_PERMISSIONS_MAP, N as NEXT_PUBLIC_WEBAPP_URL } from "./server-build-Mh3_cFus.js";
    ...
    /* @__PURE__ */ jsxs(Body, { className: "mx-auto my-auto font-sans", children: [
      ...
      /* @__PURE__ */ jsxs(Section, { className: "bg-background text-muted-foreground", children: [
        /* @__PURE__ */ jsxs(Container, { className: "mx-auto mt-8 mb-2 max-w-xl rounded-lg border border-border border-solid p-2 backdrop-blur-sm", children: [
          ...
          /* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsx(TemplateImage, { className: "mx-auto", assetBaseUrl, staticAsset: "delete-user.png" }) }),
          /* @__PURE__ */ jsxs(Section, { className: "p-2 text-muted-foreground", children: [
            /* @__PURE__ */ jsx(Text, { className: "text-center font-medium text-foreground text-lg", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
            {
              id: "mrz6cs",
              values: {
                organisationName
            ...
            /* @__PURE__ */ jsx("div", { className: "mx-auto my-2 w-fit rounded-lg bg-muted px-4 py-2 font-medium text-base text-muted-foreground", children: memberName || memberEmail })
          ] })
        ] }),
