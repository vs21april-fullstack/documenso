...
import { u as useBranding, a as getSafeBrandingUrl } from "./render-email-with-i18n-BaewMkpR.js";
const TemplateBrandingLogo = (props) => {
  ...
  if (!hasCustomBrandingLogo) {
    return /* @__PURE__ */ jsx(Text, { className: `${className} font-bold text-xl leading-none`, children: "Omni Sign" });
  }
