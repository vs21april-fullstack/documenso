import { n as env, o as isValidLanguageCode, A as APP_I18N_OPTIONS, q as SUPPORTED_LANGUAGE_CODES, _ as __variableDynamicImportRuntimeHelper, r as DEFAULT_BRAND_COLORS } from "./server-build-1kmO9YXy.js";
...
const BrandingProvider = (props) => {
  return /* @__PURE__ */ jsx(BrandingContext.Provider, { value: props.branding ?? defaultBrandingContextValue, children: props.children });
};
const useBranding = () => {
...
const TemplateFooter = ({
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    reportUrl && /* @__PURE__ */ jsx(Text, { className: "my-4 text-base text-muted-foreground", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "E4ee24",
      components: {
    ...
    isDocument && !branding.brandingHidePoweredBy && /* @__PURE__ */ jsx(Text, { className: "my-4 text-base text-muted-foreground", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
    {
      id: "yYJVSP",
      components: {
        0: /* @__PURE__ */ jsx(Link, { className: "text-primary", href: "https://api.omni00.com/published-apps/17/160/" })
      }
    } }) }),
    branding.brandingEnabled && branding.brandingCompanyDetails && /* @__PURE__ */ jsx(Text, { className: "my-8 text-muted-foreground text-sm", children: branding.brandingCompanyDetails.split("\n").map((line, idx) => {
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        idx > 0 && /* @__PURE__ */ jsx("br", {}),
        line
      ] }, idx);
    }) }),
    branding.brandingEnabled && safeBrandingUrl && /* @__PURE__ */ jsx(Text, { className: "my-8 text-muted-foreground text-sm", children: /* @__PURE__ */ jsx(Link, { href: safeBrandingUrl, target: "_blank", children: safeBrandingUrl }) }),
    !branding.brandingEnabled && /* @__PURE__ */ jsxs(Text, { className: "my-8 text-muted-foreground text-sm", children: [
      "Omni Sign",
      /* @__PURE__ */ jsx("br", {}),
...
async function loadCatalog(lang) {
  ...
  const {
    messages
  } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../translations/de/web.mjs": () => import("./web-C73fugKU.js"), "../../translations/de/web.po": () => import("./web-DYdvybBP.js"), "../../translations/en/web.mjs": () => import("./web-pdPgVIjw.js"), "../../translations/en/web.po": () => import("./web-BlEOuJ8A.js"), "../../translations/es/web.mjs": () => import("./web-AZW9eRzx.js"), "../../translations/es/web.po": () => import("./web-DOEyksdF.js"), "../../translations/fr/web.mjs": () => import("./web-c2Le3ab0.js"), "../../translations/fr/web.po": () => import("./web-CV6aXMz9.js"), "../../translations/it/web.mjs": () => import("./web-Dm5K7Fx1.js"), "../../translations/it/web.po": () => import("./web-Bi24mbe_.js"), "../../translations/ja/web.mjs": () => import("./web-D5lI3ZJX.js"), "../../translations/ja/web.po": () => import("./web-B6GxLHYV.js"), "../../translations/ko/web.mjs": () => import("./web-C-A4xt1Y.js"), "../../translations/ko/web.po": () => import("./web-CmWBZm87.js"), "../../translations/nl/web.mjs": () => import("./web-CqcDgASG.js"), "../../translations/nl/web.po": () => import("./web-0mRi3fHW.js"), "../../translations/pl/web.mjs": () => import("./web-DU9WsmMj.js"), "../../translations/pl/web.po": () => import("./web-YBa_XKPK.js"), "../../translations/pt-BR/web.mjs": () => import("./web-BjfRJJ-H.js"), "../../translations/pt-BR/web.po": () => import("./web-DTQPFL3X.js"), "../../translations/sq/web.po": () => import("./web-Dl4x2Vr6.js"), "../../translations/zh/web.mjs": () => import("./web-yKACsJOJ.js"), "../../translations/zh/web.po": () => import("./web-6CKPViTr.js") }), `../../translations/${lang}/web.${extension}`, 5);
  return {
    [lang]: messages
  };
}
...
const allMessages = async () => {
  return await catalogs.then((catalogs2) => catalogs2.reduce((acc, oneCatalog) => {
    return {
      ...acc,
      ...oneCatalog
    };
...
const renderWithI18N = async (element, options) => {
  ...
  return ReactEmail.render(/* @__PURE__ */ jsx(I18nProvider, { i18n, children: /* @__PURE__ */ jsx(BrandingProvider, { branding, children: /* @__PURE__ */ jsx(Tailwind, { config: {
    theme: {
      extend: {
        colors: tailwindColors
      }
    }
  }, children: element }) }) }), otherOptions);
};
