...
import {
  ...
  aI as DEFAULT_HANDWRITING_FONT_SIZE,
  aJ as DEFAULT_STANDARD_FONT_SIZE,
  m as DOCUMENT_AUDIT_LOG_TYPE,
  as as DOCUMENT_STATUS,
  aF as encryptSecondaryData,
  n as env,
  a1 as extractDocumentAuthMethods,
  aU as fieldsContainUnsignedRequiredField,
  at as formatDocumentAuditLogAction,
  aM as fromCheckboxValue,
  aB as getDocumentCertificateAuditLogs,
  h as getFileServerSide,
  av as getOrganisationClaimByTeamId,
  az as getSignatureFontFamily,
  a0 as getTeamSettings,
  aw as getTranslations,
  aX as isDocumentCompleted,
  aH as isSignatureFieldType,
  aV as isTspEnvelope,
  o as isValidLanguageCode,
  aK as MIN_HANDWRITING_FONT_SIZE,
  aL as MIN_STANDARD_FONT_SIZE,
  M as mapDocumentIdToSecondaryId,
  af as mapEnvelopeToWebhookDocumentPayload,
  aY as NEXT_PRIVATE_DISABLE_PDF_SIGNING,
  ar as NEXT_PRIVATE_INTERNAL_WEBAPP_URL,
  ap as NEXT_PRIVATE_SIGNING_TIMESTAMP_AUTHORITY,
  aD as NEXT_PRIVATE_USE_LEGACY_SIGNING_SUBFILTER,
  aW as NEXT_PRIVATE_USE_PLAYWRIGHT_PDF,
  aE as NEXT_PUBLIC_SIGNING_CONTACT_INFO,
  N as NEXT_PUBLIC_WEBAPP_URL,
  aC as PDF_SIZE_A4_72PPI,
  ax as parseDocumentAuditLogData,
  a7 as prefixedId,
  p as prismaWithReplicas,
  aq as putPdfFileServerSide,
  aA as RECIPIENT_ROLE_SIGNING_REASONS,
  R as RECIPIENT_ROLES_DESCRIPTION,
  aT as renderField,
  ay as svgToPng,
  ad as triggerWebhook,
  aG as USE_INTERNAL_URL_BROWSERLESS,
  ah as ZCheckboxFieldMeta,
  aQ as ZDateFieldMeta,
  aP as ZEmailFieldMeta,
  aN as ZInitialsFieldMeta,
  aO as ZNameFieldMeta,
  aR as ZNumberFieldMeta,
  ag as ZRadioFieldMeta,
  au as ZSupportedLanguageCodeSchema,
  aS as ZTextFieldMeta,
...
const run = async ({ payload, io }) => {
  ...
  if (shouldSendCompletedEmail) {
    await io.runTask('send-document-completed-emails', async () => {
      const completedEmailHandler = await import('./send-document-completed-emails.handler-CXzrBazh.js');
