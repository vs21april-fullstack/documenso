import { p as prismaWithReplicas, H as ORGANISATION_USER_ACCOUNT_TYPE, J as jobs, N as NEXT_PUBLIC_WEBAPP_URL, D as DOCUMENSO_INTERNAL_EMAIL } from "./server-build-DZjqD4tR.js";
...
const deleteOrganisation = async ({
  ...
  await Promise.all(organisation.teams.map(async (team) => orphanEnvelopes({
    teamId: team.id
  })));
