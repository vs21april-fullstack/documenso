...
import { R as RECIPIENT_ROLES_DESCRIPTION, p as prismaWithReplicas, e as unsafeBuildEnvelopeIdQuery, f as extractDerivedDocumentEmailSettings, F as RECIPIENT_ROLE_TO_EMAIL_TYPE, E as EMAIL_ASSET_BASE_URL, j as PUBLISHED_APP_URL, i as isRecipientEmailValidForSending, g as assertOrganisationRatesAndLimits, l as createDocumentAuditLogData, m as DOCUMENT_AUDIT_LOG_TYPE } from "./server-build-BldIODWZ.js";
import { useLingui, Trans } from "@lingui/react";
import { OrganisationType, RecipientRole, DocumentStatus, EnvelopeType, DocumentSource, SendStatus } from "@prisma/client";
...
import { T as TemplateBrandingLogo } from "./template-branding-logo-B53XO3Vy.js";
import { T as TemplateCustomMessageBody, b as buildEnvelopeEmailHeaders, u as updateRecipientNextReminder } from "./update-recipient-next-reminder-XkMpGURv.js";
import { match, P } from "ts-pattern";
import { Button } from "@react-email/button";
import { T as TemplateDocumentImage } from "./template-document-image-ClaHnWUr.js";
import { T as TemplateFooter, g as getI18nInstance, r as renderEmailWithI18N } from "./render-email-with-i18n-xTxBG7xG.js";
import { createElement } from "react";
import { g as getEmailContext } from "./get-email-context-_sT2jhV_.js";
...
const TemplateDocumentInvite = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Section, { children: [
      /* @__PURE__ */ jsx(Text, { className: "mx-auto mb-0 max-w-[80%] text-center font-semibold text-foreground text-lg", children: match({
        selfSigner,
        organisationType,
        includeSenderDetails,
        teamName
      ...
      } })).otherwise(() => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
      {
        id: "uySqxV",
        values: {
          0: _(actionVerb).toLowerCase(),
      ...
      /* @__PURE__ */ jsx(Section, { className: "mt-8 mb-6 text-center", children: /* @__PURE__ */ jsx(Button, { className: "inline-flex items-center justify-center rounded-lg bg-primary px-6 py-3 text-center font-medium text-base text-primary-foreground no-underline", href: signDocumentLink, children: match(role).with(RecipientRole.SIGNER, () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
      {
        id: "t6PyGz"
      } })).with(RecipientRole.VIEWER, () => /* @__PURE__ */ jsx(Trans, { .../*i18n*/
      {
    ...
    /* @__PURE__ */ jsxs(Body, { className: "mx-auto my-auto bg-background font-sans", children: [
      ...
      /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(Container, { className: "mx-auto mt-8 mb-2 max-w-xl rounded-lg border border-border border-solid p-4 backdrop-blur-sm", children: /* @__PURE__ */ jsxs(Section, { children: [
          ...
          /* @__PURE__ */ jsx(TemplateDocumentInvite, { inviterName, inviterEmail, documentName, signDocumentLink, assetBaseUrl, role, selfSigner, organisationType, teamName, includeSenderDetails })
        ] }) }),
        /* @__PURE__ */ jsx(Container, { className: "mx-auto mt-12 max-w-xl", children: /* @__PURE__ */ jsxs(Section, { children: [
          organisationType === OrganisationType.PERSONAL && /* @__PURE__ */ jsx(Text, { className: "my-4 font-semibold text-base", children: /* @__PURE__ */ jsx(Trans, { .../*i18n*/
          {
            id: "L/K/DO",
            values: {
              inviterName,
            ...
            components: {
              0: /* @__PURE__ */ jsx(Link, { className: "font-normal text-muted-foreground", href: `mailto:${inviterEmail}` })
            }
          } }) }),
          /* @__PURE__ */ jsx(Text, { className: "mt-2 text-base text-muted-foreground", children: customBody ? /* @__PURE__ */ jsx(TemplateCustomMessageBody, { text: customBody }) : /* @__PURE__ */ jsx(Trans, { .../*i18n*/
          {
            id: "wj6GQb",
            values: {
              inviterName,
